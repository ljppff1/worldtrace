...
public class CycleViewPager extends android.support.v4.app.Fragment implements OnPageChangeListener {
	...
	private LinearLayout indicatorLayout; // 鎸囩ず锟�?
	...
	private boolean isCycle = true; // 鏄惁寰幆
	private boolean isWheel = true; // 鏄惁杞挱
	private long releaseTime = 0; // 鎵嬫寚鏉惧紑銆侀〉闈笉婊氬姩鏃堕棿锛岄槻姝㈡墜鏈烘澗锟�?鍚庣煭鏃堕棿杩涜鍒囨崲
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == WHEEL && imageViews.size() != 0) {
					if (!isScrolling) {
						...
						if (position == max) { // 锟�?鍚庝竴椤垫椂鍥炲埌绗竴锟�?
	...
	/**
	 * 鏄惁寰幆锛岄粯璁や笉锟�?鍚紝锟�?鍚墠锛岃灏唙iews鐨勬渶鍓嶉潰涓庢渶鍚庨潰鍚勫姞鍏ヤ竴涓鍥撅紝鐢ㄤ簬寰幆
	 * 
	 * @param isCycle
	 *            鏄惁寰幆
	 */
	...
	/**
	 * 璁剧疆鏄惁杞挱锛岄粯璁や笉杞挱,杞挱锟�?瀹氭槸寰幆锟�?
	 * 
	 * @param isWheel
	 */
	...
	final Runnable runnable = new Runnable() {
		...
		public void run() {
			if (getActivity() != null && !getActivity().isFinishing()
				...
				// 锟�?娴嬩笂锟�?娆℃粦鍔ㄦ椂闂翠笌鏈涔嬮棿鏄惁鏈夎Е锟�?(鎵嬫粦锟�?)鎿嶄綔锛屾湁鐨勮瘽绛夊緟涓嬫杞挱
	...
	/**
	 * 璁剧疆杞挱鏆傚仠鏃堕棿锛屽嵆娌″灏戠鍒囨崲鍒颁笅锟�?寮犺锟�?.榛樿5000ms
	 * 
	 * @param time
	 *            姣涓哄崟锟�?
	 */
	...
	/**
	 * 杩斿洖褰撳墠浣嶇疆,寰幆鏃堕渶瑕佹敞鎰忚繑鍥炵殑position鍖呭惈涔嬪墠鍦╲iews锟�?鍓嶆柟涓庢渶鍚庢柟鍔犲叆鐨勮鍥撅紝鍗冲綋鍓嶉〉闈㈣瘯鍥惧湪views闆嗗悎鐨勪綅锟�?
	 * 
	 * @return
	 */
	...
	/**
	 * 濡傛灉褰撳墠椤甸潰宓屽鍦ㄥ彟锟�?涓獀iewPager涓紝涓轰簡鍦ㄨ繘琛屾粴鍔ㄦ椂闃绘柇鐖禫iewPager婊氬姩锛屽彲锟�? 闃绘鐖禫iewPager婊戝姩浜嬩欢
	 * 鐖禫iewPager锟�?瑕佸疄鐜癙arentViewPager涓殑setScrollable鏂规硶
	 */
